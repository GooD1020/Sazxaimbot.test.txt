...
local Star = nill:Window("blox fruit aimbot pvp")

local StarServer = Star:Server("SAZX HUB PVP mode",8521503225)



local Main = StarServer:Channel("aimbot v1")

local Main2 = StarServer:Channel("aimbot v2")

Main:Label("PVP aimbot")


Main:Toggle("Aim Bot Skill And Gun",false,function(value)
...
Main:Toggle("Show Fov",false,function(value)
		_G.ShowFov = value
	end)
...
Main2:Button("aimbot v2", function()
